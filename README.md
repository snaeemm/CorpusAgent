...
* **LLM**: configured to use `gemini-2.5-flash` or the user specified `gemini-3.1-flash-lite-preview`. This is because Gemini provides immense context speed and quality on the free tier suitable for robust iteration.
